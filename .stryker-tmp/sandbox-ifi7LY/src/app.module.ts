...
// T-DEADCODE-CLEANUP (2026-05-17): 删 UserModule / LifecycleModule / FeatureFlagModule
//   3-agent triple-verify 共识：0 production callers，整模块 dead code
//   详见 6 agent audit verdict（G1: architect/code-architect/general-purpose 三方共识）
