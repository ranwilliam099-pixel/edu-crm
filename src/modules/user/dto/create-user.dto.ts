 ...
 *
 * 字段口径来源：
 *   - users.role: V2__tenant_schema_template.sql CHECK 8 枚举（sales/sales_manager/sales_director/marketing/finance/boss/admin/hr）— DTO 已完全对齐
 ...
 */
/**
 * USER-AUTH(2026-05-02): DTO 角色枚举与 V2 schema CHECK 完全对齐（台账条目 30）
